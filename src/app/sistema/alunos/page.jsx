  ...
  return (
    <div>
      ...
      <table className="hidden md:table w-full text-left border-collapse">
        ...
        <tbody>
          {alunos.length === 0 ? (<div className="flex pt-10 justify-center items-center">Nenhum Aluno Encontrado</div>) :
      ...
      {alunos.length === 0 ? (<div className="md:hidden flex pt-10 justify-center items-center">Nenhum Aluno Encontrado</div>) :
        alunos.map((aluno) => (
